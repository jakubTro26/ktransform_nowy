...
if (!function_exists('of_options'))
{
	function of_options()
	{
		...
		$of_options[] = array( "name" => "Event Countdown Date",
							"desc" => "Event Countdown Date.",
							"id" => "info_countdown_date",
							"std" => "25 Jan 2017",
							"type" => "text"); //Done Change
		...
		$of_options[] = array( "name" => "Menu Button",
							"desc" => "",
							"id" => "header_info",
		...
		$of_options[] = array( "name" => "Show Button On Menu",
							"desc" => "Show/Hide Buy Ticket Button in Menu",
							"id" => "checkbox_woo_menubutton",
							"std" => 1,
							"type" => "checkbox"); //Done Change
							
		$of_options[] = array( "name" => "Button Text",
								"desc" => "Type button text here",
								"id" => "woo_buttontext",
								"std" => "Buy Now",
								"type" => "text"); //Done Change
		
		$of_options[] = array( "name" => "Button Link",
								"desc" => "Type button link here",
								"id" => "woo_buttonlink",
								"std" => "",
								"type" => "text"); //Done Change
