                    ...
                    <div class="container">
                        <div class="sixteen columns">
                            ...
                            <div class="jx-ievent-logo left"><a href="<?php echo esc_url( home_url() ); ?>">
                                <img src="<?php echo esc_url($ievent_data['dark-logo']); ?>" alt="<?php bloginfo('name'); ?>" class="logo" />
                                ...
                                <div id="jx-ievent-main-menu" class="main-menu">                               
                                    <?php
										...
										<?php if ( class_exists( 'WooCommerce' ) ) :?>
                                             <?php if ($ievent_data['checkbox_woo_menubutton']): ?>
                                    <div class="jx-ievent-ticket">
                                        <a href="<?php echo esc_url( home_url('/') ); ?>shop"><?php esc_html_e($ievent_data['woo_buttontext'],'ievent'); ?></a>
