...
function jx_ievent_scripts() {  
		...
		wp_enqueue_script('ievent-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', 'jquery','null',true);
		wp_enqueue_script('ievent-respond', get_template_directory_uri() . '/vendor/respond.js', 'jquery','null',true);
		wp_enqueue_script('ievent-appear', get_template_directory_uri() . '/vendor/jquery.appear.js', 'jquery','null',true);
		wp_enqueue_script('ievent-prettyPhoto', get_template_directory_uri() . '/vendor/prettyPhoto/jquery.prettyPhoto.js', 'jquery','null',true);
		wp_enqueue_script('ievent-isotope', get_template_directory_uri() . '/vendor/isotope/jquery.isotope.min.js', 'jquery','null',true);
		wp_enqueue_script('ievent-flexslider', get_template_directory_uri() . '/vendor/flexslider/jquery.flexslider.js', 'jquery','null',true);
		wp_enqueue_script('ievent-maginfic-popup', get_template_directory_uri() . '/vendor/magnific-popup/jquery.magnific-popup.min.js', 'jquery','null',true);
		wp_enqueue_script('ievent-validate', get_template_directory_uri() . '/vendor/jquery.validate.js', 'jquery','null',true);		
		wp_enqueue_script('ievent-modernizr', get_template_directory_uri() . '/vendor/modernizr.js', 'jquery','null',false);
		wp_enqueue_script('ievent-plugins', get_template_directory_uri() . '/js/plugins.js', 'jquery','null',true);		
		wp_enqueue_script('ievent-form-validator', get_template_directory_uri() . '/vendor/form-validator/jquery.form-validator.min.js', 'jquery','null',true);
		wp_enqueue_script('ievent-theme', get_template_directory_uri() . '/js/theme.js', 'jquery','null',true);	
		//wp_enqueue_script('google-maps','https://maps.googleapis.com/maps/api/js?v=3.exp&amp;key='.$ievent_data['google_map_key'].'&callback=init', array(), null, false);	
		wp_enqueue_script('ievent-google-recaptcha','https://www.google.com/recaptcha/api.js', array(), null, false);	
...
{  
	...
	/*---------------- Register CSS Styles ------------------------*/
	//wp_enqueue_style( 'ievent-skeleton', get_template_directory_uri() . '/css/skeleton2.css', array(),  rand(111,999), 'all' );
	...
	wp_enqueue_style( 'ievent-flexslider', get_template_directory_uri() . '/vendor/flexslider/flexslider.css', array(), '1', 'all' );
	wp_enqueue_style( 'ievent-prettyPhoto', get_template_directory_uri() . '/vendor/prettyPhoto/prettyPhoto.css', array(), '1', 'all' );
	wp_enqueue_style( 'ievent-vc-style', get_template_directory_uri() . '/css/vc_style.css', array(),  rand(111,999), 'all' );
	
	
	
		
	//Default Skin
	if (($theme_color && $theme_color!="#d6007f") or ($theme_base_color && $theme_base_color!="#333") ):
	...
	// Main Stylesheet
	wp_enqueue_style( 'stylesheet', get_stylesheet_uri(), array(), rand(111,999), 'all' ); 
