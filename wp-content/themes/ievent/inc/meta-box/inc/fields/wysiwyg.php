...
class RWMB_Wysiwyg_Field extends RWMB_Field {
	...
	static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-wysiwyg', ievent_RWMB_CSS_URL . 'wysiwyg.css', array(), ievent_RWMB_VER );
		wp_enqueue_script( 'rwmb-wysiwyg', ievent_RWMB_JS_URL . 'wysiwyg.js', array( 'jquery' ), ievent_RWMB_VER, true );
	}
