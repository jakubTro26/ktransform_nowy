...
class RWMB_Select_Field extends RWMB_Choice_Field {
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-select', ievent_RWMB_CSS_URL . 'select.css', array(), ievent_RWMB_VER );
		wp_enqueue_script( 'rwmb-select', ievent_RWMB_JS_URL . 'select.js', array(), ievent_RWMB_VER, true );
	}
