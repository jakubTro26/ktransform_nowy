...
class RWMB_Media_Field extends RWMB_File_Field {
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_media();
		wp_enqueue_style( 'rwmb-media', ievent_RWMB_CSS_URL . 'media.css', array(), ievent_RWMB_VER );
		wp_enqueue_script( 'rwmb-media', ievent_RWMB_JS_URL . 'media.js', array( 'jquery-ui-sortable', 'underscore', 'backbone', 'media-grid' ), ievent_RWMB_VER, true );
		...
		self::localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			...
			'loadingUrl'         => ievent_RWMB_URL . 'img/loader.gif',
	...
	public static function print_templates() {
		require_once ievent_RWMB_INC_DIR . 'templates/media.php';
	}
}
