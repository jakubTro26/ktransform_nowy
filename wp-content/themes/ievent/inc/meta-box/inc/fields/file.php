...
class RWMB_File_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-file', ievent_RWMB_CSS_URL . 'file.css', array(), ievent_RWMB_VER );
		wp_enqueue_script( 'rwmb-file', ievent_RWMB_JS_URL . 'file.js', array( 'jquery' ), ievent_RWMB_VER, true );
