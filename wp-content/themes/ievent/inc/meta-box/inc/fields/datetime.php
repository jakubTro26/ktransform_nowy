...
class RWMB_Datetime_Field extends RWMB_Text_Field {
	...
	public static function admin_register_scripts() {
		...
		wp_register_style( 'wp-datepicker', ievent_RWMB_CSS_URL . 'datepicker.css', array( 'jquery-ui-core', 'jquery-ui-theme' ), '1.8.17' );
		...
		$url = ievent_RWMB_JS_URL . 'jqueryui';
		...
		wp_register_script( 'rwmb-datetime', ievent_RWMB_JS_URL . 'datetime.js', array( 'jquery-ui-datepicker', 'jquery-ui-timepicker-i18n' ), ievent_RWMB_VER, true );
		wp_register_script( 'rwmb-date', ievent_RWMB_JS_URL . 'date.js', array( 'jquery-ui-datepicker' ), ievent_RWMB_VER, true );
		wp_register_script( 'rwmb-time', ievent_RWMB_JS_URL . 'time.js', array( 'jquery-ui-timepicker-i18n' ), ievent_RWMB_VER, true );
