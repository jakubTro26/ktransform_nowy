...
class RWMB_Range_Field extends RWMB_Number_Field {
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-range', ievent_RWMB_CSS_URL . 'range.css', array(), ievent_RWMB_VER );
		wp_enqueue_script( 'rwmb-range', ievent_RWMB_JS_URL . 'range.js', array(), ievent_RWMB_VER, true );
	}
