...
class RWMB_Map_Field extends RWMB_Field {
	...
	static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'rwmb-map', ievent_RWMB_CSS_URL . 'map.css' );
		wp_enqueue_script( 'rwmb-map', ievent_RWMB_JS_URL . 'map.js', array( 'jquery-ui-autocomplete', 'google-maps' ), ievent_RWMB_VER, true );
	}
	...
	static function the_value( $field, $args = array(), $post_id = null ) {
		...
		$google_maps_url = apply_filters( 'rwmb_google_maps_url', $google_maps_url );
		wp_register_script( 'google-maps', esc_url_raw( $google_maps_url ), array(), '', true );
		wp_enqueue_script( 'rwmb-map-frontend', ievent_RWMB_JS_URL . 'map-frontend.js', array( 'google-maps' ), '', true );
