...
class RWMB_Autocomplete_Field extends RWMB_Multiple_Values_Field {
	...
	static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-autocomplete', ievent_RWMB_CSS_URL . 'autocomplete.css', array( 'wp-admin' ), ievent_RWMB_VER );
		wp_enqueue_script( 'rwmb-autocomplete', ievent_RWMB_JS_URL . 'autocomplete.js', array( 'jquery-ui-autocomplete' ), ievent_RWMB_VER, true );
