        ...
        <div class="speaker-content" data-mcs-theme="dark">
            ...
            <div class="speaker-social">
                <ul>
                    ...
                    <?php if (get_post_meta(get_the_id(),'jx_ievent_speaker_instagram','ievent')): ?>
                    <li><a href="http://www.instagram.com/<?php echo get_post_meta(get_the_id(),'jx_ievent_speaker_instagram','ievent'); ?>"><i class="fa fa-instagram"></i></a></li>
                    <?php endif; ?>
                </ul>
            </div>
            <!-- EOF Social -->	           
