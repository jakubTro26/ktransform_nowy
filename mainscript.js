...
if(window.location.href=="https://kongrestransformacji.pl/kontakt/")
{
  ...
  document.querySelector('body > div.jx-ievent-summary-info > div > ul > li:nth-child(2) > div > div > div.jx-ievent-bar-head').innerText="535-312-144";
...
$('#speakers > div.container > div > div > div > div:nth-child(2) > div:nth-child(3) > div > div > div > div > p:nth-child(2)').style.margin="0px";
...
$('#sponsorzy').style.transform="translateX(-44%)";
 ...
 // dodajimg2();df
  ...
  $('.parallax-no.bg-pos-center').style.background=" url('https://kongrestransformacji.pl/wp-content/uploads/2018/12/image.jpg')";
...
var countDownDate = new Date("Oct 28, 2021 7:00:00").getTime();
...
document.querySelector('#sponsorzy').insertAdjacentElement('afterBegin',a)
